    ...
    return (uri, range, cancle, resultProgress) => {
        ...
        function getHtmlResult(sourceFile) {
            ...
            for (const sourceMap of [...sourceFile.getHtmlSourceMaps(), ...sourceFile.getPugSourceMaps()]) {
                const inSourceMap = [...sourceMap].some(mapping => (mapping.sourceRange.start >= offsetRange.start && mapping.sourceRange.start <= offsetRange.end)
                    || (mapping.sourceRange.end >= offsetRange.start && mapping.sourceRange.end <= offsetRange.end));
                if (!inSourceMap)
                    continue;
                const htmlStart = (_b = (_a = sourceMap.getMappedRange2(offsetRange.start)) === null || _a === void 0 ? void 0 : _a.start) !== null && _b !== void 0 ? _b : 0;
